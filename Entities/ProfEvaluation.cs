namespace Entities
{
	...
	public class ProfEvaluation
	{
		public ProfEvaluation()
		{
			EvaluationValues = new HashSet<ProfEvaluationValue>();
		}
		...
		public virtual ICollection<ProfEvaluationValue> EvaluationValues { get; set; }
